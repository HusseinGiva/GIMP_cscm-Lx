...
Uses
  ...
  StdCtrls, ExtCtrls, ComCtrls, Unit2, Unit3;
    ...
    Begin
      ...
      Begin
        ...
        Begin
          ...
          Begin
            red_a := red_a + Red(Form1.Image1.Picture.Bitmap.Canvas.Pixels[i +
              m, j + n]);
            green_a := green_a +
              Green(Form1.Image1.Picture.Bitmap.Canvas.Pixels[i + m, j + n]);
            blue_a := blue_a +
